        ...
        {currentSection === 0 && (
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Skills & Documents</h3>
              ...
              {formData.resume ? (
                <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <span className="text-green-800 dark:text-green-200">{formData.resume.name}</span>
                  </div>
                  <button
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">
                Skills {parsedResumeData && <span className="text-green-600">(Auto-filled from resume)</span>}
              </label>
              ...
              <div className="flex flex-wrap gap-2">
                {formData.skills.map((skill, index) => (
                  ...
                  >
                    {skill}
                    <button onClick={() => removeSkill(skill)} className="ml-2 hover:text-blue-600">
                      <X className="h-3 w-3" />
                    </button>
                  </span>
                ))}
            ...
            {/* Cover Letter */}
            <div>
              <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">Cover Letter</label>
              <textarea
                rows={6}
            ...
            <div>
              ...
              <FileUploadArea type="additional" accept=".pdf,.doc,.docx" multiple />
            </div>
          </motion.div>
        )}
        ...
        {currentSection === 1 && (
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              {parsedResumeData && (
                <span className="text-green-600 text-sm">Auto-filled from resume</span>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">State</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">ZIP Code</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">LinkedIn URL</label>
                <input
                  type="url"
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">Portfolio URL</label>
                <input
                  type="url"
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
            ...
            {formData.education.map((edu, index) => (
              <div key={edu.id} className="p-4 border border-gray-200 dark:border-gray-600 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">Institution *</label>
                    <input
                      type="text"
                      required
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">Degree</label>
                    <input
                      type="text"
                      value={edu.degree}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">Field of Study</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">Graduation Year</label>
                    <input
                      type="number"
                ...
                <div className="mt-4">
                  <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">GPA (Optional)</label>
                  <input
                    type="text"
                    value={edu.gpa}
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
            ...
            {formData.experience.map((exp, index) => (
              <div key={exp.id} className="p-4 border border-gray-200 dark:border-gray-600 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">Company *</label>
                    <input
                      type="text"
                      required
                      value={exp.company}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">Start Date</label>
                    <input
                      type="month"
                      value={exp.startDate}
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">End Date</label>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
            ...
            <div className="p-4 border border-gray-200 dark:border-gray-600 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">Notice Period</label>
                  <select
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div>
                  <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">Salary Expectation</label>
                  <input
                    type="text"
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...prev,
                        availability: { ...prev.availability, salaryExpectation: e.target.value },
                      }))
                    }
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-gray-100">Work Type Preference</label>
                  <select
                    value={formData.availability.workType}
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...prev,
                        availability: { ...prev.availability, workType: e.target.value },
                      }))
                    }
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                  >
                  ...
                  {question.type === "textarea" && (
                    <textarea
                      ...
                      onChange={(e) =>
                        setFormData((prev) => ({
                          ...prev,
                          questions: { ...prev.questions, [question.id]: e.target.value },
                        }))
                      }
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                    />
